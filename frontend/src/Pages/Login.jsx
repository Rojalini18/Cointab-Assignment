    ...
    if (!currentRef.current) {
      let Timer = setTimeout(() => {
        if (count > 4) {
          ...
          fetch(`http://localhost:4000/countupdate`, {
            method: "PATCH",
            headers: {
  ...
  const handleLogin = () => {
    ...
    fetch("http://localhost:4000/login", {
      ...
      .then((res) => {
        ...
        if (
          res.message ===
          "Can not attempt more than 5 times. Try after 24 hrs"
        ) {
        ...
        <Box w={{ base: "80%", sm: "80%", md: "60%", lg: "40%" }}>
          ...
          >
            ...
            <Box w="70%" m="auto">
              ...
              <br/>
              <Text color="red">Can not login after entering wrong password 5 times.</Text>
            </Box>
          </Box>
        </Box>
      )}
